  ...
  return (
    <nav className="navbar relative z-50 py-7 flex items-center justify-between px-6 md:px-12">
      ...
      >
        ...
        {/* ⭐ Tambahan baru */}
        <li><a href="#education" className="sm:text-lg text-base font-medium">Education</a></li>
        <li><a href="#services" className="sm:text-lg text-base font-medium">Services</a></li>
