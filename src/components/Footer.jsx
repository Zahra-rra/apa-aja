    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://www.tiktok.com/@aellaa_vrlte?_r=1&_t=ZS-91r1peXTsS9"><i className="ri-tiktok-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=copy_link&utm_content=7sp27km"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://x.com/neyra_sya?t=SMo3RR5PS6eFQvVpfq76JQ&s=08"><i className="ri-twitter-fill ri-2x"></i></a>
        </div>
